 ...
 * @author Jeff
 */
public class TelaSwingSoma extends javax.swing.JFrame {

    /**
     * Creates new form TelaSwingSoma
     */
    public TelaSwingSoma() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSwingSoma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaSwingSoma().setVisible(true);
            }
        });
    }
